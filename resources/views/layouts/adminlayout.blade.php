...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item active">
        <a class="nav-link" href="http://127.0.0.1:8000/admin/categoryadd">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <span>Category Add</span></a>
      </li>
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item active">
        <a class="nav-link" href="http://127.0.0.1:8000/admin/productadd">
          <i class="fas fa-fw fa-tachometer-alt"></i>
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item active">
        <a class="nav-link" href="http://127.0.0.1:8000/admin/brand">
          <i class="fas fa-fw fa-tachometer-alt"></i>
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item active">
        <a class="nav-link" href="http://127.0.0.1:8000/admin/brandadd">
          <i class="fas fa-fw fa-tachometer-alt"></i>
  ...
  <script src="http://127.0.0.1:8000/js/demo/chart-area-demo.js"></script>
  <script src="http://127.0.0.1:8000/js/demo/chart-pie-demo.js"></script>
